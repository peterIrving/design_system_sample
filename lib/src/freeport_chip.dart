...
//         // as most themes don't have a dedicated success color in ColorScheme
    ...
    switch (variant) {
      ...
      case ChipVariant.success:
        ...
        final Color onSuccessColor =
            _isDark(successColor)
                ? Colors.white
                : Colors.black;

        return ChipColors(
          backgroundColor: successColor.withOpacity(0.2),
          selectedColor: successColor.withOpacity(0.3),
          disabledColor: successColor.withOpacity(0.1),
          labelColor: successColor,
          selectedLabelColor: successColor,
